...
export default function About() {
  return (
    ...
    <div id='sobremi' className="w-[90%]  mx-auto h-screen md:grid grid-cols-2 justify-center align-center ">
        ...
        <div className="col-span-1 text-white rounded-[10px] bg-violet-600 text-center justify-center  align-center m-auto w-[90%] h-[60%] md:h-[70%] shadow-black shadow-lg"> 
          <div>
